    ...
    return (
        <View className="bg-slate-200 mt-5 w-[100%] pt-5">
            ...
            <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} className="flex-row my-5 py-5">
                <Pressable className="items-center mx-[-40] ml-[1]" onPress={()=> { setSearch('Cardiologist'); navigation.navigate('Doctor'); }}>
                ...
                <Pressable className="items-center mx-[-40] ml-[1]" onPress={()=> { setSearch('Neurologist'); navigation.navigate('Doctor'); }}>
                ...
                <Pressable className="items-center mx-[-40] ml-[1]" onPress={()=> { setSearch('Dentist'); navigation.navigate('Doctor'); }}>
                ...
                <Pressable className="items-center mx-[-40] ml-[1]" onPress={()=> { setSearch('General Physician'); navigation.navigate('Doctor'); }}>
                ...
                <Pressable className="items-center mx-[-40] ml-[1]" onPress={()=> { setSearch('Orthopedic'); navigation.navigate('Doctor'); }}>
                ...
                <Pressable className="items-center mx-[-40] ml-[1]" onPress={()=> { setSearch('Urology'); navigation.navigate('Doctor'); }}>
