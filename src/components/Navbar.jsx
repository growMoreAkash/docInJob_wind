...
const Navbar = () => {
    ...
    return (
        <View className="absolute top-0 left-0 right-0 mt-8 pt-9 px-5 pb-5 h-auto flex-row items-center z-10 border-b flex justify-between border-gray-300 bg-white ">
            <View className="ml-4">
